    ...
    <header className="bg-white  stick">
      ...
      <Link to='/' className="text-base font-semibold leading-6 text-gray-900">Home</Link>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-base font-semibold leading-6 text-gray-900 bg-blue-500 rounded-md shadow-2xl px-10 py-2 text-white">
            Contact 
          </a>
        </div>
      </nav>
      <Dialog as="div"  className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel data-aos='fade-right' className="fixed inset-y-0 left-0 z-10 d-width overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
