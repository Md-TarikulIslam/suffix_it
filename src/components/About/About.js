...
const About = () => {
  return (
    <div className="about-box">
      ...
      <div className="about-flex2" id="aboutSection">
        <div
          data-aos="fade-right"
          data-aos-offset="300"
          data-aos-easing="ease-in-sine"
          className="about-all-text"
        >
          <p className="history">OUR HISTORY</p>
          <p className="moto">Who we are?</p>
          <p className="moto-details">
            At Suffix IT, we develop innovative and creative products and
            ...
            quality of our work. As a leader in technology exploring, Suffix IT
            is committed to exporting quality software worldwide.
          </p>
          <p className="moto2">Vision</p>
          <p className="moto-details">
            Our goal is to become a well-known global ICT solution provider that
            meets societal needs and contributes favorably to humanity's
            interests.
          </p>
          <p className="moto2">Mission</p>
          <p className="moto-details">
            To use our enthusiasm for technology to bring success and happiness
            to our clients and staff thus also providing high-growth
            possibilities for rewarding employment and thereby serve humanity.
          </p>
        </div>
        <div
          data-aos="fade-left"
        ...
        >
          <img
            className="about-img"
            src="https://i.ibb.co/KN8Rb5c/IMG-4808.png"
            alt=""
          />
        </div>
      </div>
