      ...
      <div>
        ...
        data-aos-easing="ease-in-sine"
            ...
            <div className="flex mb-10">
             <a href="#work"> <button className="btn">LET'S EXPLORE</button></a>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/t9XYLboQdSg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
