    ...
    <div className="footer-area">
      <div className="flex10">
        <div>
          ...
          <div className="logo-flex">
            <a target="_blank" href="https://www.facebook.com/suffixworld">
              <FaFacebook className="b-logo" />{" "}
            </a>
            <FaTwitter className="b-logo" />
            <a
              target="_blank"
              href="https://www.linkedin.com/company/suffix-it-limited/mycompany/"
            >
        ...
        <div>
          ...
          <img
            className="foo-img"
            src="https://suffixit.com/static/media/basis.4d3b2ce9.svg"
            alt=""
          />
          <img
            className="foo-img"
            src="https://suffixit.com/static/media/bacco.bd0330ea.png"
            alt=""
          />
        </div>
      </div>
      <div>
        ...
        <div className="term-flex">
          <p className="rights-all">
            <span>
              {" "}
              &copy; 2023 All Rights Reserved by{" "}
              <span className="text-blue-500">Suffix IT</span>
            </span>
          </p>
